...
| **Execution Latency** | `byteval!` | `[u8; 3]` | **0.95x (Faster!)** | **2.67x Higher** |
| **Execution Latency** | `bitstruct!` | `u16` | **1.32x** (Atomic) | **2.00x Higher** |
| **Execution Latency** | `bytestruct!` | `[u8; 2]` | **3.14x** (Optimized) | **3.20x Higher** |
